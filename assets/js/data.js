...
`,
    ...
    p10: {
      ...
      html: `
        ...
        `,
      tags: ['C++', 'Multi-Agent Systems', 'Path Planning', 'Robotics', 'PID Control', 'Systems Architecture'],
      links: [
  ...
  exp: {
    e7: {
      htmlShort: `
        <ul style="font-size:0.9rem;line-height:1.8;color:var(--muted);padding-left:1.2rem">
          <li>Assumed full technical ownership of the reconciliations product area within two months — the previous lead departed mid-project, and I drove it forward as the only engineer on one of the most critical parts of the product</li>
      ...
      `,
      html: `
        <p>I shipped 3 features to production for thousands of customers and owned the entire reconciliations product area — picking up accounting as a new domain from scratch in the process. Within two months of joining, the engineer leading reconciliations departed mid-project, and I assumed full technical ownership — the only engineer actively working on one of the most critical parts of the product.</p>
    ...
    e5: {
      htmlShort: `
        ...
        <ul style="font-size:0.9rem;line-height:1.8;color:var(--muted);padding-left:1.2rem;margin-bottom:1.1rem">
          ...
          <li>Received three Aurora immediate recognition awards for individual contributions across programs</li>
        </ul>
        ...
        <ul style="font-size:0.9rem;line-height:1.8;color:var(--muted);padding-left:1.2rem;margin-bottom:1.1rem">
          ...
          <li>Collaborated with a teammate to extend the CP-SAT decision model with time-dependent logic, allowing optimal technology selections to persist across multi-year planning horizons</li>
      ...
      `,
      tags: ['Python', 'React', 'TypeScript', 'FastAPI', 'PostgreSQL', 'C++', 'Optimization', 'Full-Stack Development', 'Systems Architecture', 'Technical Communication']
    },
    e4: {
      htmlShort: `
        <ul style="font-size:0.9rem;line-height:1.8;color:var(--muted);padding-left:1.2rem">
